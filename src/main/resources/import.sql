...
-----------------------------------------
-- TABELA: investimentos (histórico dos clientes)
-- Esses dados ajudam no cálculo do perfil de risco
-----------------------------------------
INSERT INTO investimentos (clienteId, tipo, valor, rentabilidade, data)
VALUES
...
-----------------------------------------
-- TABELA: simulacoes
-- Dados opcionais só pra API não parecer "vazia"
-----------------------------------------
INSERT INTO simulacoes (clienteId, produto, valorInvestido, valorFinal, prazoMeses, dataSimulacao)
VALUES
    (123, 'CDB Caixa 2026', 10000.00, 11200.00, 12, '2025-10-31T14:00:00Z'),
    (123, 'Fundo XPTO Multimercado', 5000.00, 5800.00, 6, '2025-09-15T10:30:00Z'),
    (456, 'Tesouro Selic 2028', 7000.00, 7850.00, 10, '2025-08-20T11:10:00Z');
